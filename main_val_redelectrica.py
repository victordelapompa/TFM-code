...
X_train, y_train, X_test, y_test, t = lector.leer_ree(val = True, reduced = int(sys.argv[2]) == 1, carpeta1 = carpeta, carpeta2 = '')
...
error_list = algoritmos.gp_val(kernels, X_train, y_train, X_test, y_test)
